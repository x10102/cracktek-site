...
<body>
    ...
    <div class="page-main">
        ...
        <div class="para-block">
            <h2>NĚCO O MĚ</h2>
            <p>Jsem to já, jen já a nikdo jinej. Teď už mám svojí vlastní <i>Webpage</i>, jak říkají cool děcka. Já nejsem cool, ale jednou budu. Slibuju mami. Studuju rap tak pečlivě, jako studuju kebab. Melu hovna. Melu kafe. Měl bych se jít vyspat.</p>
        </div>
        <div class="para-block">
            <h2>VZDĚLÁNÍ</h2>
            <p>Jo, jsem student. To mi dává docela prestižní status, ne? Takže, co studuju?</p>
            <ul>
